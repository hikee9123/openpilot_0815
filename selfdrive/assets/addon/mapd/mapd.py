...
class MapD():
  ...
  def publish(self, pm, sm):
    ...
    map_data_msg.valid = True # sm.all_checks(service_list=['gpsLocationExternal'])
    ...
    map_data_msg.liveMapData.turnSpeedLimitsAheadCnt = len(map_data_msg.liveMapData.turnSpeedLimitsAheadSigns)
