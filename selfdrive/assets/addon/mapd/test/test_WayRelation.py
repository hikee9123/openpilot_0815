...
from selfdrive.assets.addon.mapd.lib.WayRelation import WayRelation, is_osm_time_condition_active, \
...
from selfdrive.assets.addon.mapd.test.mock_data import mockOSMWay_01_01_LongCurvy, mockOSMWay_01_02_Loop, \
...
class TestWayRelationFileFunctions(unittest.TestCase):
  ...
  @mock.patch('selfdrive.assets.addon.mapd.lib.WayRelation.dt')
